...
void FillSpinAlignment(const Int_t energy = 2, const Int_t X_flag = 0, const Int_t List = 0, const Long64_t start_event = 0, const Long64_t stop_event = 1024, const Int_t mode = 0)
{

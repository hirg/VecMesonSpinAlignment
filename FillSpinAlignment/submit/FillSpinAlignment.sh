...
#    counter=0
    ...
    do
      ...
      echo -n "root4star -b -q -x 'FillSpinAlignment.C(" >> run$Name$counter.csh
###############################energy###################################
...
##############################Partilce##################################
      ...
      sbatch -p shared-chos -t 4:00:00 -o /global/project/projectdirs/starprod/rnc/xusun/OutPut/AuAu${Energy}/Log/job$Name$counter.log -e /global/project/projectdirs/starprod/rnc/xusun/OutPut/AuAu${Energy}/Log/job$Name$counter.err ./run$Name$counter.csh

...
namespace vmsa
{
  ...
  float const InvMass[3] = {1.01946,1.11568,0.49761}; // 0: phi, 1: Lambda, 2 K0S
  int const decayChannelsFirst[3] = {656,1058,613};
  int const decayChannelsSecond[3] = {666,1061,614};
  int const decayMother[3] = {333,3122,310};
  int const decayChannels[3] = {656,1058,613}; // 0: phi->K+K-, 1: Lambda->ppi, 2 K0S->pi+pi-

...
then
  PID=Kminus
  Energy=62GeV
  Year=run10 # run10 for 7.7, 11.5, 39 and 62.4 GeV | run11 for 19.6, 27 and 200 GeV | run14 for 14.5
  ...
  do
    ...
    qsub -hard -l scratchfree=500,h_cpu=00:30:00,h_vmem=1.8G,projectio=1 -o /global/project/projectdirs/starprod/rnc/xusun/OutPut/AuAu$Energy/Log/embedding_${PID}_$counter.log -e /global/project/projectdirs/starprod/rnc/xusun/OutPut/AuAu$Energy/Log/embedding_${PID}_$counter.err ./embedding_${PID}_$counter.csh

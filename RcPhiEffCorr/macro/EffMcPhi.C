...
void EffMcPhi(const int Energy = 4, const long StartEvent = 0, const long StopEvent = 10000024, const int PID = 0, const int Year = 1, const int Cut = 0) // Energy = 0: 7GeV, 1: 11GeV, 2: 19GeV, 3: 27GeV, 4: 39GeV, 5: 62GeV, 6: 200 GeV | PID = 0: phi, 1 Kstar | Year = 0: run11, 1 run10 | Cut = 0: pr, 1: gl
{

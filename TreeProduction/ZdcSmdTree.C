...
StChain *chain;
void ZdcSmdTree(const Char_t *inputFile="/project/projectdirs/starprod/rnc/xusun/OutPut/AuAu200GeV/List/run_list/200GeV_140.list", const Int_t jobCounter = 140, const Int_t Mode = 1, const Int_t energy = 6, const Int_t flag_ME = 0)
{
